...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Place an Order", "\tAs a customer\r\n\tI want to place an order for the items present in the cart\r\n\tSo " +
                    "that I can buy it", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Place order for items added to the cart")]
        [NUnit.Framework.CategoryAttribute("PlaceOrder")]
        public virtual void PlaceOrderForItemsAddedToTheCart()
        {
            string[] tagsOfScenario = new string[] {
                    "PlaceOrder"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Place order for items added to the cart", null, tagsOfScenario, argumentsOfScenario);
#line 7
